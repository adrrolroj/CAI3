...
public class FileHashingUtils {
	 ...
	 *
	 * @param path
	 *            Path, en forma canónica.
	 * @param algorithm
	 *            Algoritmo que se debe usar al calcular el hash.
	 * @return Bytes conteniendo el hash del archivo.
	 * @throws IOException
	 *             El archivo no existe o no se puede leer.
	 * @throws IllegalArgumentException
	 *             El path no esta en forma canónica.
	 * @throws RuntimeException
	 *             El algoritmo no esta soportado por la plataforma.
	 */
	public static byte[] getHashOfFile(final String path, final String algorithm) throws IOException {
	 ...
	 *
	 * @param path
	 *            Path al archivo en forma canónica.
	 * @param hashHexString
	 *            Cadena hexadecimal que representa el hash del archivo.
	 * @param algorithm
	 *            Algoritmo que se usó al calcular el hash original.
	 * @return True si el hash actual coincide con el que se pasó como argumento.
	 * @throws IOException
	 *             Archivo no encontrado o no se puede leer.
	 * @throws IllegalArgumentException
	 *             Path no esta en forma canónica.
	 * @throws RuntimeException
	 *             Algoritmo no soportado por la plataforma.
	 */
	public static boolean compareHashOfFile(final String path, final String hashHexString, final String algorithm) throws IOException {
		byte[] hashOfFile = FileHashingUtils.getHashOfFile(path, algorithm);
		String hexStringOfFile = FileHashingUtils.byteArrayToHexString(hashOfFile);
	 ...
	 */
	public static void checkFilePath(final String filePath) throws IOException {
